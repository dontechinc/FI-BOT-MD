...
global.ownMain = '256704376077';
global.NamaOwner = 'FI BOT MD 𝚩𝐔𝐆'; // Do not change 
global.sessionName = 'session';
global.connect = true; // Set to false if using QR Code
global.namabot = '𝚸𝚫𝚻𝚪𝚯𝚴 𝛁1 𝚩𝐔𝐆'; // Do not change
global.author = 'DON TECH INC 𝚩𝐔𝐆'; // Do not change
global.packname = 'DON TECH INC 🚹'; // Change if needed
global.url = 'https://whatsapp.com/channel/0029VajvAYL7YScvdKu2dA1r'; // Do not change
global.url = 'https://chat.whatsapp.com/GC5e2ptmzih75n2hB5b9tr'; // Do not change
