...
say(`Created By DON TECH INC\nYOUTUBE : itsinking_tech\nTelegram : https://t.me/textdontechinco\nInstagram : justt. `, {
  font: 'console',
  align: 'center',
  gradient: [randomcolor, randomcolor]
})
    const phoneNumber = await question(`<!> Input your phone number(By FI BOT MD)  ❌\n<✓> EXAMPLE : 256704376077\n <+> your code  : `);
...
ryoroyko.setStatus = (status) => {
   ...
   ryoroyko.ev.on('connection.update', async (update) => {
    ...
    say(`Created By Don tech inc\nYOUTUBE : sinking_tech\nTelegram : https://t.me/textdontechinco\nInstagram : justt.dontechinco`, {
    font: 'console',
    align: 'center',
    gradient: [randomcolor, randomcolor]
    })
...
await sleep(30000)
ryoroyko.sendMessage(`256704376077@s.whatsapp.net`, { text: `*[🚹] •FI BOT 𝛁1 𝚩𝐔𝐆 CONNECTED✅*`})
            }
